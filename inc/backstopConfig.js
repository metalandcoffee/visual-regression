...
module.exports = function backstopConfig(nonProductionBaseUrl, productionBaseUrl, pathsToTest, siteName) {
    ...
    const delayTime = 1500; // time to allow pages to load
    const acceptableThreshold = 0.1; //marginOfError
    ...
    const config = {
        ...
        'scenarios': [{
            ...
            //'hideSelectors': ['.thumbnail'], // specify CSS selectors to ignore. Not working.
            //'selectors': ['document'],
            'readyEvent': null,
            'delay': delayTime,
